...
from PyQt6.QtWidgets import QApplication, QWidget, QLabel, QLineEdit, \
    QPushButton, QComboBox, QGridLayout, QMainWindow, QTableWidget, \
...
class DatabaseConnection:
    def __init__(self, host="localhost", user="root",
                 password="bethebestDev95#", database="school"):
        self.host = host
        self.user = user
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        add_student_action = QAction(QIcon("icons/add.png"), "Add a student", self)
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
           This app was created during the learning process.
